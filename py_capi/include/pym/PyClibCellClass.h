...
//////////////////////////////////////////////////////////////////////
/// @class PyClibCellClass PyClibCellClass.h "PyClibCellClass.h"
/// @brief ClibCellClass を Python から使用するための拡張
///
...
public:
  ...
  /// @brief PyObject* から ClibCellClass を取り出すファンクタクラス
  struct Deconv {
    bool
    operator()(
...
public:
  ...
  {
    ElemType val;
    if ( PyClibCellClass::FromPyObject(obj, val) ) {
      return val;
    }
    PyErr_SetString(PyExc_TypeError, "Could not convert to ClibCellClass");
    return val;
  }

  /// @brief ClibCellClass を表す PyObject から ClibCellClass を取り出す．
  /// @return ClibCellClass を返す．
  ///
