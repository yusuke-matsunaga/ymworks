...
public:
  ...
  /// @brief SatInitParam を PyObject* に変換するファンクタクラス
  struct Conv {
    PyObject*
    operator()(
  ...
  /// @brief PyObject* から SatInitParam を取り出すファンクタクラス
  struct Deconv {
    bool
    operator()(
...
public:
  ...
  /// @brief SatInitParam を表す PyObject を作る．
  ...
  {
    ElemType val;
    if ( PySatInitParam::FromPyObject(obj, val) ) {
      return val;
    }
