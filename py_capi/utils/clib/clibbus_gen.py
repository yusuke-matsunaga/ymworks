...
class ClibBusGen(PyObjGen):

    def __init__(self):
        super().__init__(classname='ClibBus',
                         pyname='ClibBus',
                         namespace='YM',
                         header_include_files=['ym/ClibBus.h',
                                               'ym/ClibPin.h'],
                         source_include_files=['pym/PyClibBus.h',
                                               'pym/PyClibBusType.h',
                                               'pym/PyClibPin.h',
                                               'pym/PyClibList.h',
                                               'pym/PyString.h',
        ...
        def get_bus_type(writer):
            writer.gen_return_pyobject('PyClibBusType',
                                       'val.bus_type()')
        self.add_getter('get_bus_type',
                        func_body=get_bus_type)
        self.add_attr('bus_type',
                      getter_name='get_bus_type',
                      doc_str='bus type')
