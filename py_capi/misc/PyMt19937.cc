...
// std::mt19937 を PyObject に変換する．
PyObject*
PyMt19937::Conv::operator()(
  const ElemType& val ///< [in] 元の値
)
{
  auto type = PyMt19937::_typeobject();
  auto obj = type->tp_alloc(type, 0);
  auto my_obj = reinterpret_cast<Mt19937_Object*>(obj);
  new (&my_obj->mVal) std::mt19937(val);
  return obj;
}

// PyObject を std::mt19937 に変換する．
bool
PyMt19937::Deconv::operator()(
  PyObject* obj, ///< [in] Python のオブジェクト
  ElemType& val  ///< [out] 結果を格納する変数
)
{
  if ( PyMt19937::Check(obj) ) {
    val = PyMt19937::_get_ref(obj);
    return true;
  }
  return false;
}
