...
TEST_F(ParserTest, Disable1)
{
  ...
  EXPECT_EQ( PtStmtType::Disable, stmt->type() );
...
TEST_F(ParserTest, Enable1)
{
  ...
  EXPECT_EQ( std::vector<const PtNameBranch*>{},
	     stmt->namebranch_list() );
  EXPECT_EQ( name, stmt->fullname() );
  EXPECT_EQ( PtStmtType::Enable, stmt->type() );
...
TEST_F(ParserTest, SysEnable)
{
  ...
  EXPECT_EQ( std::vector<const PtNameBranch*>{},
	     stmt->namebranch_list() );
  EXPECT_EQ( name, stmt->fullname() );
  EXPECT_EQ( PtStmtType::SysEnable, stmt->type() );
...
TEST_F(ParserTest, DcStmt)
{
  ...
  EXPECT_EQ( PtStmtType::DelayControl, stmt->type() );
...
TEST_F(ParserTest, EcStmt)
{
  ...
  EXPECT_EQ( std::vector<const PtNameBranch*>{},
	     stmt->namebranch_list() );
  EXPECT_EQ( "", stmt->fullname() );
  EXPECT_EQ( PtStmtType::EventControl, stmt->type() );
...
TEST_F(ParserTest, Wait)
{
  ...
  EXPECT_EQ( std::vector<const PtNameBranch*>{},
	     stmt->namebranch_list() );
  EXPECT_EQ( "", stmt->fullname() );
  EXPECT_EQ( PtStmtType::Wait, stmt->type() );
...
TEST_F(ParserTest, Assign1)
{
  auto fr = make_file_region(1, 2, 3, 4);
  auto fr1 = make_file_region(1, 1, 1, 1);
  auto lhs = parser.new_IntConst(fr1, 0U);
  auto fr3 = make_file_region(3, 3, 3, 3);
  ...
  EXPECT_EQ( std::vector<const PtNameBranch*>{},
	     stmt->namebranch_list() );
  EXPECT_EQ( "", stmt->fullname() );
  EXPECT_EQ( PtStmtType::Assign, stmt->type() );
...
TEST_F(ParserTest, NbAssign1)
{
  ...
  EXPECT_EQ( std::vector<const PtNameBranch*>{},
	     stmt->namebranch_list() );
  EXPECT_EQ( "", stmt->fullname() );
  EXPECT_EQ( PtStmtType::NbAssign, stmt->type() );
...
TEST_F(ParserTest, PcAssign)
{
  ...
  EXPECT_EQ( std::vector<const PtNameBranch*>{},
	     stmt->namebranch_list() );
  EXPECT_EQ( "", stmt->fullname() );
  EXPECT_EQ( PtStmtType::PcAssign, stmt->type() );
...
TEST_F(ParserTest, Deassign)
{
  ...
  EXPECT_EQ( std::vector<const PtNameBranch*>{},
	     stmt->namebranch_list() );
  EXPECT_EQ( "", stmt->fullname() );
  EXPECT_EQ( PtStmtType::Deassign, stmt->type() );
...
TEST_F(ParserTest, Force)
{
  ...
  EXPECT_EQ( std::vector<const PtNameBranch*>{},
	     stmt->namebranch_list() );
  EXPECT_EQ( "", stmt->fullname() );
  EXPECT_EQ( PtStmtType::Force, stmt->type() );
...
TEST_F(ParserTest, Release)
{
  ...
  EXPECT_EQ( std::vector<const PtNameBranch*>{},
	     stmt->namebranch_list() );
  EXPECT_EQ( "", stmt->fullname() );
  EXPECT_EQ( PtStmtType::Release, stmt->type() );
...
TEST_F(ParserTest, EventStmt)
{
  auto fr = make_file_region(1, 2, 3, 4);
  auto fr1 = make_file_region(1, 1, 1, 1);
  auto event = parser.new_IntConst(fr1, 0U);
  ...
  EXPECT_EQ( std::vector<const PtNameBranch*>{},
	     stmt->namebranch_list() );
  EXPECT_EQ( "", stmt->fullname() );
  EXPECT_EQ( PtStmtType::Event, stmt->type() );
...
TEST_F(ParserTest, NullStmt)
{
  ...
  EXPECT_EQ( std::vector<const PtNameBranch*>{},
	     stmt->namebranch_list() );
  EXPECT_EQ( "", stmt->fullname() );
  EXPECT_EQ( PtStmtType::Null, stmt->type() );
