...
{
  ASSERT_NOT_REACHED;
  return std::vector<const VlDecl*>{};
}
...
{
  ASSERT_NOT_REACHED;
  return std::vector<const VlDeclArray*>{};
}
...
{
  ASSERT_NOT_REACHED;
  return std::vector<const VlDefParam*>{};
}
...
{
  ASSERT_NOT_REACHED;
  return std::vector<const VlParamAssign*>{};
}
...
{
  ASSERT_NOT_REACHED;
  return std::vector<const VlModuleArray*>{};
}
...
{
  ASSERT_NOT_REACHED;
  return std::vector<const VlModule*>{};
}
...
{
  ASSERT_NOT_REACHED;
  return std::vector<const VlPrimArray*>{};
}
...
{
  ASSERT_NOT_REACHED;
  return std::vector<const VlPrimitive*>{};
}
...
{
  ASSERT_NOT_REACHED;
  return std::vector<const VlTaskFunc*>{};
}
...
{
  ASSERT_NOT_REACHED;
  return std::vector<const VlContAssign*>{};
}
...
{
  ASSERT_NOT_REACHED;
  return std::vector<const VlProcess*>{};
}
...
{
  ASSERT_NOT_REACHED;
  return std::vector<const VlScope*>{};
}
...
private:
  ...
  // 要素のリスト
  std::vector<const VlScope*> mList;
...
private:
  ...
  // 要素のリスト
  std::vector<const VlDeclArray*> mList;
...
private:
  ...
  // 要素のリスト
  std::vector<const VlDefParam*> mList;
...
private:
  ...
  // 要素のリスト
  std::vector<const VlParamAssign*> mList;
...
private:
  ...
  // 要素のリスト
  std::vector<const VlModuleArray*> mList;
...
private:
  ...
  // 要素のリスト
  std::vector<const VlModule*> mList;
...
private:
  ...
  // 要素のリスト
  std::vector<const VlPrimArray*> mList;
...
private:
  ...
  // 要素のリスト
  std::vector<const VlPrimitive*> mList;
...
private:
  ...
  // 要素のリスト
  std::vector<const VlTaskFunc*> mList;
...
private:
  ...
  // 要素のリスト
  std::vector<const VlContAssign*> mList;
...
private:
  ...
  // 要素のリスト
  std::vector<const VlProcess*> mList;
