...
using PtAttrInstArray    = PtArray<const AstAttrInst>;
using PtAttrSpecArray    = PtArray<const AstAttrSpec>;
using PtCaseItemArray    = PtArray<const AstCaseItem>;
using PtConnectionArray  = PtArray<const AstConnection>;
using PtContAssignArray  = PtArray<const AstContAssign>;
using PtDeclHeadArray    = PtArray<const AstDeclHead, PtDeclHead>;
using PtDeclItemArray    = PtArray<const AstDeclItem>;
using PtDefParamArray    = PtArray<const AstDefParam>;
using PtExprArray        = PtArray<const AstExpr>;
using PtGenCaseItemArray = PtArray<const AstGenCaseItem>;
using PtInstArray        = PtArray<const AstInst>;
using PtIOHeadArray      = PtArray<const AstIOHead, PtIOHead>;
using PtIOItemArray      = PtArray<const AstIOItem>;
using PtItemArray        = PtArray<const AstItem, PtItem>;
using PtNameBranchArray  = PtArray<const AstNameBranch>;
using PtRangeArray       = PtArray<const AstRange>;
using PtPortArray        = PtArray<const AstPort, PtPort>;
using PtStmtArray        = PtArray<const AstStmt>;
using PtUdpEntryArray    = PtArray<const AstUdpEntry>;
using PtUdpValueArray    = PtArray<const AstUdpValue>;
