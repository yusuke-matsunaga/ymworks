...
public:
  ...
  new_CmbUdp(
    ...
    const PtPort* port_top,     ///< [in] ポート名の配列
    const PtIOHead* io_top,     ///< [in] IOの配列
  ...
  new_UdpEntry(
    ...
    const PtUdpValue* input_top, ///< [in] 入力値の配列
  ...
  new_Module(
    ...
    const PtDeclHead* decl_top,       ///< [in] 宣言のリスト
    const PtItem* item_top            ///< [in] 要素のリスト
  );
  ...
  new_DeclItem(
    const FileRegion& fr,    ///< [in] ファイル位置の情報
    const char* name,        ///< [in] 名前
    const PtRange* range_top ///< [in] 配列の範囲の末尾
  );
  ...
  new_DefParamH(
    const FileRegion& fr,      ///< [in] ファイル位置の情報
    const PtDefParam* elem_top ///< [in] 要素のリスト
  );
  ...
  new_ContAssignH(
    const FileRegion& fr,        ///< [in] ファイル位置の情報
    const PtContAssign* elem_top ///< [in] 要素の先頭
  );
  ...
  new_Task(
    ...
    const PtIOHead* iodecl_top, ///< [in] IO宣言のリスト
    const PtDeclHead* decl_top, ///< [in] 宣言のリスト
  ...
  new_GateH(
    ...
    const PtInst* elem_top ///< [in] 要素の配列
  );
  ...
  new_MuH(
    const FileRegion& fr,                ///< [in] ファイル位置の情報
    const char* def_name,	         ///< [in] 定義名
    const PtConnection* paramassign_top, ///< [in] パラメータ割り当てリスト
    const PtInst* elem_top               ///< [in] 要素の配列
  );
  ...
  new_Inst(
    ...
    const char* name,	        ///< [in] 名前
    const PtRange* range,       ///< [in] パース木の範囲定義
    const PtConnection* con_top ///< [in] ポート割り当ての配列
  );
  ...
  new_Generate(
    const FileRegion& fr,       ///< [in] ファイル位置の情報
    const PtDeclHead* decl_top, ///< [in] 宣言の先頭
    const PtItem* item_top      ///< [in] 要素の先頭
  );
  ...
  new_GenIf(
    ...
    const PtDeclHead* then_decl_top, ///< [in] then 節の宣言の先頭
    const PtItem* then_item_top      ///< [in] then 節の要素の先頭
  );
  ...
  new_GenIfElse(
    ...
    const PtDeclHead* then_decl_top, ///< [in] then 節の宣言の先頭
    const PtItem* then_item_top,     ///< [in] then 節の要素の先頭
    const PtDeclHead* else_decl_top, ///< [in] then 節の宣言の先頭
    const PtItem* else_item_top      ///< [in] then 節の要素の先頭
  );
  ...
  new_GenCase(
    ...
    const PtGenCaseItem* item_top ///< [in] generate case item の先頭
  );
  ...
  new_GenCaseItem(
    const FileRegion& fr,       ///< [in] ファイル位置の情報
    const PtExpr* label_top,    ///< [in] 比較式の先頭
    const PtDeclHead* decl_top, ///< [in] 宣言の先頭
    const PtItem* item_top      ///< [in] 要素の先頭
  );
  ...
  new_SpecItem(
    ...
    const PtExpr* terminal_top ///< [in] 端子のリスト
  );
  ...
  new_Enable(
    ...
    const PtExpr* arg_top ///< [in] 引数のリスト
  );
  ...
  new_Case(
    const FileRegion& fr,          ///< [in] ファイル位置の情報
    const PtExpr* expr,            ///< [in] 条件式
    const PtCaseItem* caseitem_top ///< [in] case item の先頭
  );
  ...
  new_CaseItem(
    const FileRegion& fr,    ///< [in] ファイル位置の情報
    const PtExpr* label_top, ///< [in] ラベルの先頭
    const PtStmt* body       ///< [in] 本体のステートメント
  );
  ...
  new_ParBlock(
    const FileRegion& fr,  ///< [in] ファイル位置の情報
    const PtStmt* stmt_top ///< [in] 本体のステートメントのリスト
  );
  ...
  new_Concat(
    const FileRegion& fr,  ///< [in] ファイル位置の情報
    const PtExpr* expr_top ///< [in] オペランドの先頭
  );
  ...
  new_Primary(
    const FileRegion& fr,   ///< [in] ファイル位置の情報
    const char* name,       ///< [in] 識別子名
    const PtExpr* index_top ///< [in] インデックスの先頭
  );
  ...
  new_EventControl(
    const FileRegion& fr,   ///< [in] ファイル位置の情報
    const PtExpr* event_top ///< [in] イベントの先頭
  );
  ...
  new_RepeatControl(
    const FileRegion& fr,   ///< [in] ファイル位置の情報
    const PtExpr* rep,      ///< [in] 繰り返し数を表す式
    const PtExpr* event_top ///< [in] 繰り返しの単位となるイベントの先頭
  );
  ...
  new_AttrInst(
    const FileRegion& fr,    ///< [in] ファイル位置の情報
    const PtAttrSpec* as_top ///< [in] attribute spec の先頭
  );
