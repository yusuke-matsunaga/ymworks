...
public:
  ...
  new_CmbUdp(
    ...
    const std::vector<const PtIOHead*>& io_array,
  ...
  new_Port(
    const FileRegion& fr,
    const PtExpr* portref,
    const std::vector<const PtExpr*>& port_ref_array,
    const char* ext_name
  ) override;
  ...
  new_ContAssignH(
    ...
    const PtStrength* strength,
    const PtDelay* delay,
    const std::vector<const PtContAssign*>& elem_array
  ) override;
  ...
  new_GenIf(
    const FileRegion& fr,
    const PtExpr* cond,
    const std::vector<const PtDeclHead*>& then_declhead_array,
    const std::vector<const PtItem*>& then_item_array,
    const std::vector<const PtDeclHead*>& else_declhead_array,
    const std::vector<const PtItem*>& else_item_array
  ) override;
  ...
  new_GenCase(
    const FileRegion& fr,
    const PtExpr* expr,
    const std::vector<const PtGenCaseItem*>& item_array
  ) override;
  ...
  new_GenCaseItem(
    const FileRegion& fr,
    const std::vector<const PtExpr*>& label_array,
    const std::vector<const PtDeclHead*>& declhead_array,
    const std::vector<const PtItem*>& item_array
  ) override;
  ...
  new_SpecItem(
    const FileRegion& fr,
    VpiSpecItemType id,
    const std::vector<const PtExpr*>& terminal_top
  ) override;
  ...
  new_Case(
    const FileRegion& fr,
    const PtExpr* expr,
    const std::vector<const PtCaseItem*>& caseitem_array
  ) override;
  ...
  new_ParBlock(
    const FileRegion& fr,
    const std::vector<const PtStmt*>& stmt_array
  ) override;
