...
public:
  ...
  find_obj_up(
    ...
    const PtHierNamedBase* pt_obj, ///< [in] 階層名付きのオブジェクト
...
public:
  ...
  new_PartSelect(
    ...
    const PtExpr* index1,  ///< [in] インデックス1の式
    const PtExpr* index2,  ///< [in] インデックス2の式
...
private:
  ...
  // UserSystf の辞書
  std::unordered_map<std::string, const VlUserSystf*> mSystfHash;
