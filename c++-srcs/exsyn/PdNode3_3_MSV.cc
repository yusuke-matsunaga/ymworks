...
/// @file PdNode3_3_MSV.cc
/// @brief PdNode3_3_MSV の実装ファイル
...
void
PdNode3_3_MSV::add_op_order_cond(
  SatSolver& solver,
  const OpNode* op
) const
{
  auto op_msv = reinterpret_cast<const PdNode3_3_MSV*>(op);
