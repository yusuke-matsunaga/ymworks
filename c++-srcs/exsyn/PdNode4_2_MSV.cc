...
/// @file PdNode4_2_MSV.cc
/// @brief PdNode4_2_MSV の実装ファイル
...
void
PdNode4_2_MSV::add_op_order_cond(
  SatSolver& solver,
  const OpNode* op
) const
{
  auto op_msv = reinterpret_cast<const PdNode4_2_MSV*>(op);
