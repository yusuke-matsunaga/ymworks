#ifndef PDNODE4_4_SSV_H
#define PDNODE4_4_SSV_H

/// @file PdNode4_4_SSV.h
/// @brief PdNode4_4_SSV のヘッダファイル
...
//////////////////////////////////////////////////////////////////////
/// @class PdNode4_4_SSV PdNode4_4_SSV.h "PdNode4_4_SSV.h"
/// @brief
//////////////////////////////////////////////////////////////////////
class PdNode4_4_SSV :
  public PdNode4
...
private:
  ...
  {
    return mLitArray[((opr0 * input_num() + opr1) * input_num() + opr2) * input_num() + opr3];
  }
...
private:
  ...
  // ((i1 * input_num() * input_num()) + (i2 * input_num()) + i3) * input_num() + i4
  // の位置に変数を格納した配列
  // i1 < i2 < i3 < i4 なので未使用の領域がある．
