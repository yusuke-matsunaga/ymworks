...
/// @file PdNode2_2_OSV2.cc
/// @brief PdNode2_2_OSV2 の実装ファイル
...
void
PdNode2_2_OSV2::add_no_reapplication_cond(
  SatSolver& solver,
  const OpNode* op2
) const
{
...
void
PdNode2_2_OSV2::add_ng_operand_cond(
  SatSolver& solver,
  SizeType opr0,
  SizeType opr1
) const
...
void
PdNode2_2_OSV2::add_op_order_cond(
  SatSolver& solver,
  const OpNode* op
) const
{
  auto op_osv = reinterpret_cast<const PdNode2_2_OSV2*>(op);
