...
/// @file PdNode4_1_OneHot.cc
/// @brief PdNode4_1_OneHot の実装ファイル
...
//////////////////////////////////////////////////////////////////////
// クラス PdNode4_1_OneHot
//////////////////////////////////////////////////////////////////////

// @brief コンストラクタ
PdNode4_1_OneHot::PdNode4_1_OneHot(
  SatSolver& solver,
  SizeType input_num,
  SizeType op_id,
  SizeType opr1,
  SizeType opr2,
  SizeType opr3
) : PdNode4_1(solver, input_num, op_id, opr1, opr2, opr3),
...
SatLiteral
PdNode4_1_OneHot::add_ovar_cond(
  SatSolver& solver,
...
) const
{
  ...
  for ( SizeType sel0 = 0; sel0 < input_num(); ++ sel0 ) {
    ...
    // 演算ノードの入力と出力に関する条件
    add_op_cond(solver, ival_list[sel0], ivar1, ivar2, ivar3, ovar);
  }
  return ovar;
}
...
void
PdNode4_1_OneHot::add_op_order_cond(
  SatSolver& solver,
  const OpNode* op
) const
{
  auto op_onehot = reinterpret_cast<const PdNode4_1_OneHot*>(op);
  auto n = mSel0.size();
