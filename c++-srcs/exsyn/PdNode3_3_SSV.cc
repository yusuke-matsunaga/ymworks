...
/// @file PdNode3_3_SSV.cc
/// @brief PdNode3_3_SSV の実装ファイル
...
void
PdNode3_3_SSV::add_op_order_cond(
  SatSolver& solver,
  const OpNode* op
) const
{
  auto op_osv = reinterpret_cast<const PdNode3_3_SSV*>(op);
